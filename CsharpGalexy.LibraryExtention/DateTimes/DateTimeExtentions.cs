...
using System.Globalization;
    ...
    public static class DateTimeExtensions
    {
        ...
        {
            var pc = new PersianCalendar();
            var dt = new DateTime(pc.GetYear(dateTime), pc.GetMonth(dateTime), pc.GetDayOfMonth(dateTime));
            return dt.ToString(format, new CultureInfo("fa-IR"));
        }
        ...
        public static string GetPersianDayOfWeek(this DateTime dateTime)
        {
            ...
            // In Persian calendar, Saturday is first day (index 6 in Gregorian)
